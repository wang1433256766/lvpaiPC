...
//     curl_setopt($ch,CURLOPT_SSLCERT, getcwd() . '/static/CAcert/apiclient_cert.pem');

//     //默认格式为PEM，可以注释

//     curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');

//     curl_setopt($ch,CURLOPT_SSLKEY, getcwd() . '/static/CAcert/apiclient_key.pem');

//     //默认格式为PEM，可以注释

//     curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');

//     curl_setopt($ch,CURLOPT_CAINFO, getcwd() . '/static/CAcert/rootca.pem');
...
//判断权限是否存在
function check_auth($control,$action){
